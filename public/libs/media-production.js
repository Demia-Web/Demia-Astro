...
document.addEventListener("astro:page-load", () => {
  gsap.to("#list-about", {
    ...
    scrollTrigger: {
      ...
      scrub: true, // Valore aumentato per rendere lo scrub più fluido
      pin: true,
      pinSpacing: true, // Rimuove lo spazio creato durante il pin per una transizione più naturale
      anticipatePin: 1, // Mantiene il valore per anticipare l'effetto pin
      invalidateOnRefresh: true, // Assicura che il calcolo venga aggiornato al ridimensionamento della finestra
      onUpdate: (self) => {
        // Aggiungi throttle manuale qui se ci sono problemi di prestazioni
